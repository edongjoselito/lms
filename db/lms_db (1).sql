...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2026 at 02:08 AM
...
CREATE TABLE `activities` (
  ...
  `type` enum('assignment','quiz','forum','resource','page','label') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'page',
...
(5, 12, 'quiz', 'Quiz 1', '', '{\"quiz_id\": 2}', 1, 1, '2026-04-25 15:52:50');
...
(1, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-01 14:32:14'),
(2, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-01 15:07:10'),
(3, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-01 15:07:26'),
(4, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-01 15:07:52'),
(5, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-01 15:07:53'),
(6, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-01 15:07:53'),
(7, 23, 'view_course', 'student', 'Viewed course content for subject ID: 10', '::1', '2026-05-02 01:07:06');
...
CREATE TABLE `announcements` (
  ...
  `audience` enum('all','teachers','students','parents','section') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
...
CREATE TABLE `class_programs` (
  ...
  `enrollment_key` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by_user_id` int UNSIGNED DEFAULT NULL,
  `semester_id` int UNSIGNED DEFAULT NULL,
  `schedule_day` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `class_programs` (`id`, `section_id`, `subject_id`, `teacher_id`, `enrollment_key`, `created_by_user_id`, `semester_id`, `schedule_day`, `schedule_time_start`, `schedule_time_end`, `room`, `status`) VALUES
(3, 5, 6, NULL, 'CIT1A', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(4, 6, 10, NULL, '2026', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(5, 6, 11, NULL, '2026', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(6, 7, 12, NULL, '123', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(7, 8, 10, NULL, 'qwerty', 21, NULL, NULL, NULL, NULL, NULL, 1);
...
(20, 10, 23, 'student', 'active', '2026-05-01 14:32:14');
...
CREATE TABLE `co_po_mapping` (
  ...
  `level` enum('I','D','A') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'I'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `enrollments` (
  ...
  `section_id` int UNSIGNED DEFAULT NULL,
  `system_type` enum('deped','ched') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'deped',
  ...
  `status` enum('pending','enrolled','dropped','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `gpa_records` (
  ...
  `status` enum('regular','dean_list','probation','dismissed') COLLATE utf8mb4_unicode_ci DEFAULT 'regular',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `grade_components` (
  ...
  `subject_category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `grade_levels` (
  ...
  `category` enum('elementary','junior_high','senior_high') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `learning_areas` (
  ...
  `code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` enum('core','applied','specialized','elective') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'core'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `lessons` (
  ...
  `content_type` enum('text','page','file','video','link') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
...
(8, 6, 10, '2026-05-01 15:07:06'),
(9, 6, 11, '2026-05-01 15:07:23');
...
CREATE TABLE `melcs` (
  `id` int UNSIGNED NOT NULL,
  `subject_id` int UNSIGNED NOT NULL,
  `competency_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `parents` (
  `id` int UNSIGNED NOT NULL,
  `user_id` int UNSIGNED NOT NULL,
  `relationship` enum('father','mother','guardian') COLLATE utf8mb4_unicode_ci DEFAULT 'guardian',
...
(1, 'login_image', '95c25006529b06a3edf88c44480def52.png', '2026-04-24 16:55:15', '2026-04-24 16:55:15');
...
CREATE TABLE `programs` (
  ...
  `code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `degree_type` enum('bachelor','master','doctorate','diploma','certificate') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bachelor',
  `total_units` decimal(5,1) DEFAULT NULL,
...
CREATE TABLE `question_bank` (
  `id` int UNSIGNED NOT NULL,
  `subject_id` int UNSIGNED NOT NULL,
  `question_type` enum('multiple_choice','identification','essay','true_false') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `quizzes` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `quiz_type` enum('quiz','exam','assignment','activity') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'quiz',
...
INSERT INTO `quizzes` (`id`, `course_id`, `class_program_id`, `school_id`, `title`, `description`, `quiz_type`, `component_id`, `total_points`, `time_limit_minutes`, `max_attempts`, `shuffle_questions`, `show_results`, `available_from`, `available_until`, `is_published`, `created_by`, `created_at`) VALUES
(2, 12, NULL, 4, 'Quiz 1', '', 'quiz', 5, 50.00, 30, 1, 1, 1, '2026-04-25 15:53:00', '2026-04-26 15:53:00', 1, 20, '2026-04-25 15:52:50');
...
(3, 2, 'network', 0, 3),
(4, 2, 'database', 0, 4),
(5, 3, 'Integrated Development Environment', 1, 1),
(6, 3, 'Internal Design Engine', 0, 2),
(7, 3, 'Internet Development Editor', 0, 3),
(8, 3, 'Integrated Data Extension', 0, 4),
(9, 4, 'Community', 1, 1),
(10, 4, 'Enterprise', 0, 2),
(11, 4, 'Professional', 0, 3),
(12, 4, 'Ultimate', 0, 4),
(13, 5, 'Desktop', 1, 1),
(14, 5, 'Mobile', 0, 2),
(15, 5, 'Cloud', 0, 3),
...
(17, 6, 'Designer', 1, 1),
(18, 6, 'Compiler', 0, 2),
(19, 6, 'Output Window', 0, 3),
(20, 6, 'Property Grid', 0, 4),
(21, 7, 'Toolbox', 1, 1),
(22, 7, 'Server Explorer', 0, 2),
(23, 7, 'Properties Window', 0, 3),
(24, 7, 'Menu Strip', 0, 4),
(25, 8, 'Solution', 1, 1),
(26, 8, 'Object', 0, 2),
(27, 8, 'Project', 0, 3),
...
(59, 16, 'lbl', 0, 3),
(60, 16, 'frm', 0, 4),
(61, 17, 'To authenticate users before allowing access', 1, 1),
(62, 17, 'To print reports automatically', 0, 2),
(63, 17, 'To delete all records in the database', 0, 3),
(64, 17, 'To change the computer password', 0, 4),
(65, 18, 'SELECT', 1, 1),
(66, 18, 'INSERT', 0, 2),
(67, 18, 'UPDATE', 0, 3),
(68, 18, 'DELETE', 0, 4),
...
(83, 22, 'Display', 0, 3),
(84, 22, 'Design', 0, 4),
(85, 23, 'INSERT INTO', 1, 1),
(86, 23, 'SELECT FROM', 0, 2),
(87, 23, 'DELETE FROM', 0, 3),
(88, 23, 'ALTER TABLE', 0, 4),
(89, 24, 'SELECT', 1, 1),
(90, 24, 'UPDATE', 0, 2),
(91, 24, 'DROP', 0, 3),
(92, 24, 'CREATE', 0, 4),
...
(103, 27, 'GROUP BY', 0, 3),
(104, 27, 'VALUES', 0, 4),
(105, 28, 'DataGridView', 1, 1),
(106, 28, 'Label', 0, 2),
(107, 28, 'PictureBox', 0, 3),
(108, 28, 'Timer', 0, 4),
(109, 29, 'Create', 1, 1),
(110, 29, 'Delete', 0, 2),
(111, 29, 'Exit', 0, 3),
...
(123, 32, 'Read', 0, 3),
(124, 32, 'Update', 0, 4),
(125, 33, 'Use parameterized queries', 1, 1),
(126, 33, 'Concatenate the text directly into SQL', 0, 2),
(127, 33, 'Use only uppercase letters', 0, 3),
(128, 33, 'Store password in Label control', 0, 4),
(129, 34, 'The main form or dashboard opens', 1, 1),
(130, 34, 'The database is deleted', 0, 2),
(131, 34, 'The username textbox disappears forever', 0, 3),
(132, 34, 'The application shuts down immediately', 0, 4),
(133, 35, 'Show an error message', 1, 1),
(134, 35, 'Open the dashboard anyway', 0, 2),
(135, 35, 'Delete the user account automatically', 0, 3),
(136, 35, 'Restart the computer', 0, 4),
(137, 36, 'PasswordChar', 1, 1),
(138, 36, 'ForeColor', 0, 2),
(139, 36, 'Multiline', 0, 3),
(140, 36, 'ReadOnly', 0, 4),
(141, 37, 'MySqlConnection', 1, 1),
(142, 37, 'SqlPrintConnection', 0, 2),
(143, 37, 'FormConnection', 0, 3),
(144, 37, 'LabelConnection', 0, 4),
(145, 38, 'MySqlCommand', 1, 1),
(146, 38, 'MySqlLabel', 0, 2),
(147, 38, 'MySqlTextbox', 0, 3),
(148, 38, 'MySqlDesigner', 0, 4),
(149, 39, 'MySqlDataAdapter', 1, 1),
(150, 39, 'MySqlForeColor', 0, 2),
(151, 39, 'MySqlTimer', 0, 3),
(152, 39, 'MySqlCase', 0, 4),
(153, 40, '=', 1, 1),
(154, 40, '>', 0, 2),
(155, 40, '&', 0, 3),
(156, 41, '=', 0, 1),
...
(173, 45, 'Reset', 0, 4),
(174, 46, 'Crash', 1, 1),
(175, 46, 'Compile faster', 0, 2),
(176, 46, 'Auto-save the form', 0, 3),
(177, 46, 'Change the form color', 0, 4),
(178, 47, 'CInt', 1, 1),
(179, 47, 'CDbl', 0, 2),
(180, 47, 'ToString', 0, 3),
(181, 47, 'MsgBox', 0, 4),
...
CREATE TABLE `rubric_criteria` (
  ...
  `excellent_desc` text COLLATE utf8mb4_unicode_ci,
  `proficient_desc` text COLLATE utf8mb4_unicode_ci,
  `developing_desc` text COLLATE utf8mb4_unicode_ci,
  `beginning_desc` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `schools` (
  `id` int UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `school_id_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` enum('deped','ched','both') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'deped',
...
(7, 4, 4, '1A', '', NULL, NULL, NULL, NULL, NULL, 40, 1),
(8, 4, 4, '1ITA', '', NULL, NULL, NULL, NULL, NULL, 40, 1);
...
CREATE TABLE `section_enrollment_keys` (
  ...
  `course_id` int UNSIGNED NOT NULL,
  `section_id` int UNSIGNED NOT NULL,
  `enrollment_key` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `semesters` (
  ...
  `school_year_id` int UNSIGNED NOT NULL,
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('quarter','semester') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'quarter',
...
CREATE TABLE `students` (
  ...
  `status` enum('active','inactive','graduated','dropped','transferred') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, 6, 1, 'LRN-6-1776810616', 'STU-6-1776810616', 'deped', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2026-04-22 06:30:16', '2026-05-01 12:37:55'),
...
(6, 23, 4, 'LRN-23-1777611318', 'STU-23-1777611318', 'deped', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2026-05-01 12:55:18', '2026-05-01 12:55:18');
...
CREATE TABLE `student_grades` (
  ...
  `remarks` enum('passed','failed','incomplete','dropped','in_progress') COLLATE utf8mb4_unicode_ci DEFAULT 'in_progress',
...
CREATE TABLE `subjects` (
  ...
  `program_id` int UNSIGNED DEFAULT NULL,
  `year_level` tinyint DEFAULT NULL,
  `semester_type` enum('quarter','1st_sem','2nd_sem','summer') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `subjects` (`id`, `school_id`, `teacher_id`, `code`, `name`, `description`, `cover_photo`, `system_type`, `grade_level_id`, `learning_area_id`, `strand_id`, `program_id`, `year_level`, `semester_type`, `units`, `lec_hours`, `lab_hours`, `status`, `created_at`) VALUES
(3, 1, NULL, 'CS 101', '', 'Intro to Information Technology', NULL, 'deped', NULL, NULL, NULL, NULL, 1, NULL, 3.0, 2.0, 1.0, 1, '2026-04-21 11:59:56'),
(4, 1, NULL, 'madf', '', 'dfasdf', NULL, 'deped', NULL, NULL, NULL, 1, 1, '1st_sem', 3.0, 2.0, 1.0, 1, '2026-04-21 15:40:28'),
(5, 1, NULL, 'Math 10', '', 'College Algebra and Trigonometry', NULL, 'deped', NULL, NULL, NULL, 1, 1, '2nd_sem', 3.0, 3.0, 0.0, 1, '2026-04-21 15:41:21'),
(6, 1, NULL, 'ABC1', '', 'ABC1', NULL, 'deped', NULL, NULL, NULL, 1, 2, '1st_sem', 3.0, 3.0, 0.0, 1, '2026-04-21 15:41:43'),
(10, 4, NULL, 'Tech2', '', 'Introduction to Programming 1', '3645daca2cc513df00eca85259073f51.jpg', 'deped', 0, NULL, NULL, 5, NULL, '1st_sem', 3.0, 0.0, 0.0, 1, '2026-04-22 08:48:21'),
(11, 4, NULL, 'Tech 1', '', 'Into to Information Technology', NULL, 'deped', 0, NULL, NULL, 5, NULL, '1st_sem', NULL, NULL, NULL, 1, '2026-04-22 10:33:22'),
(12, NULL, NULL, 'WEB2', '', 'Web development 2', NULL, 'deped', NULL, NULL, NULL, 5, NULL, NULL, NULL, NULL, NULL, 1, '2026-04-25 11:55:52'),
(13, NULL, NULL, 'Web2', '', 'Website', NULL, 'deped', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-04-25 12:03:18'),
(14, NULL, NULL, 'TECH3', '', 'Programming 3', NULL, 'deped', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-04-25 14:29:45');
...
CREATE TABLE `teachers` (
  ...
  `employment_type` enum('regular','part_time','contractual') COLLATE utf8mb4_unicode_ci DEFAULT 'regular',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, NULL, 'Super', NULL, 'Admin', NULL, 'admin@lms.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, 1, '2026-05-01 11:47:34', '2026-04-20 20:36:52', '2026-05-01 11:47:34'),
...
(6, 5, 1, 'Carlos', NULL, 'Garcia', NULL, 'student@school.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, 1, '2026-05-01 12:37:55', '2026-04-20 20:59:20', '2026-05-01 12:37:55'),
...
(19, 2, 4, 'Janndale', '', 'Buot', '', 'janndalebuot@gmail.com', '$2y$10$f4fTqBy5NdiJCvTmuVBdVurOx2G0c.gfPkXfjI/mGbB1jR.CpvPkm', '', NULL, 1, '2026-05-30 07:58:11', '2026-04-25 11:36:28', '2026-05-30 07:58:11'),
(20, 7, 4, 'Micro', '', 'Bots', '', 'microbots06@gmail.com', '$2y$10$9Q9yJuRpLb3KmFGYkPiSJOtIC5Q7px9vEMm/D5kZQ4HklkzFaAf4G', '', NULL, 1, '2026-05-18 19:05:00', '2026-04-25 14:08:05', '2026-05-18 19:05:00'),
(21, 4, 4, 'Janndale', '', 'Buot', '', 'janndale.buot@deped.gov.ph', '$2y$10$A.Zh1YXXL.CMyU8IUFeBKeQitoj1pqFTmO59o3QicoQ17vD96XYU.', '', NULL, 1, '2026-05-02 07:14:59', '2026-04-25 15:59:35', '2026-05-02 07:14:59'),
(22, 4, 4, 'Joselit', '', 'Edong', '', 'jann.buot@user.com', '$2y$10$lnQ4aQbSTeYHOF58NXhKNOcwCmxABFoKFVdJfQ52h1NivTfAZ9J/2', '', NULL, 1, '2026-05-01 11:52:08', '2026-05-01 11:50:35', '2026-05-01 11:52:08'),
(23, 5, 4, 'Javee', '', 'Bayang', '', 'javee@softtehc.com', '$2y$10$FnSDr4l.BpiZAi/yFEct5OxX.CFocQhwtK08J2IebLRJVET6uVZuq', '', NULL, 1, '2026-05-02 01:06:58', '2026-05-01 12:55:11', '2026-05-02 01:06:58');
